...
public class AngleAdjustController  implements SwerveController {
  ...
  public AngleAdjustController(Supplier<Double> getMeasurment , double setPointDrgrees) {
    ...
    // angleLog = new LoggedDouble("/Subsystems/Swerve/Controllers/Odometry Adjust/Angle");//UPDATE LOG
  ...
  public ChassisSpeeds update() {
    ...
    // angleLog.update(ConvUtil.DegreesToRadians(measurment.get()));//UPDATE LOG
