...
public class VelocitySystemConstants extends DeafultSystemConstants<VelocitySystemConstants> {
    ...
    public VelocitySystemConstants withRealGains(GainConfig gainConfig) { this.realGainConfig = gainConfig; return this; }
    public VelocitySystemConstants withSimGains(GainConfig gainConfig) { this.simGainConfig = gainConfig; return this; }
    public GainConfig getGainConfig() { return simGainConfig; }
    public VelocitySystemConstants withWheelRadius(double wheelRadius) { this.WHEEL_RADIUS = wheelRadius; return this; }
    public VelocitySystemConstants withTolerance(double tolerance) { this.TOLERANCE = tolerance; return this; }
    ...
    public static final class Builder {
        ...
        /* subclass options */
        public Builder maxVelocity(double maxVel) { this.maxVelocity = maxVel; return this; }
        public Builder tolerance(double tolerance) { this.tolerance = tolerance; return this; }
        public Builder wheelRadius(double radius) { this.wheelRadius = radius; return this; }
