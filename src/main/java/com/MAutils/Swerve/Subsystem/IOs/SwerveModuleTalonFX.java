...
public class SwerveModuleTalonFX implements SwerveModule {
    ...
    private StatusSignal<Current> stallCurrentStat;
    ...
    protected LoggedBool stallCurrent;
    ...
    public SwerveModuleTalonFX(String moduleNameN, int driveID,
        ...
        stallCurrent = new LoggedBool("/Subsystems/Swerve/Modules/" + moduleName + "/Stall Current");
        ...
        stallCurrentStat = driveMotor.getMotorStallCurrent();
    ...
    private void configDriveMotor() {
        ...
        driveConfiguration.Slot0.kP = SwerveConstants.TELEOP_DRIVE_kP;
        driveConfiguration.Slot0.kI = SwerveConstants.TELEOP_DRIVE_kI;
        driveConfiguration.Slot0.kD = SwerveConstants.TELEOP_DRIVE_kD;
        driveConfiguration.Slot0.kS = SwerveConstants.TELEOP_DRIVE_kS;
        driveConfiguration.Slot0.kV = SwerveConstants.TELEOP_DRIVE_kV;
        driveConfiguration.Slot0.kA = SwerveConstants.TELEOP_DRIVE_kA;

        driveConfiguration.Slot1.kP = SwerveConstants.AUTO_DRIVE_kP;
        driveConfiguration.Slot1.kI = SwerveConstants.AUTO_DRIVE_kI;
        driveConfiguration.Slot1.kD = SwerveConstants.AUTO_DRIVE_kD;
        driveConfiguration.Slot1.kS = SwerveConstants.AUTO_DRIVE_kS;
        driveConfiguration.Slot1.kV = SwerveConstants.AUTO_DRIVE_kV;
        driveConfiguration.Slot1.kA = SwerveConstants.AUTO_DRIVE_kA;

        driveConfiguration.CurrentLimits.StatorCurrentLimitEnable = SwerveConstants.DRIVE_ENBLE_CURRENT_LIMIT;
        driveConfiguration.CurrentLimits.StatorCurrentLimit = SwerveConstants.DRIVE_CONTINUOS_LOWER__LIMIT;
    ...
    public void turningUsingPID(double setPointRdians) {
        turningMotor.setControl(pidTurnController.withPosition(Units.radiansToRotations(setPointRdians))
                .withSlot(SwerveConstants.TELEOP_SLOT_CONFIG));
    }
    ...
    public void driveUsingPID(double setPointMPS, double feedForward) {
        ...
        if (DriverStation.isAutonomous()) {
            driveMotor.setControl(driveController.withVelocity(rpsDriveSetPoint)
                    .withSlot(SwerveConstants.AUTO_SLOT_CONFIG).withEnableFOC(true));
        } else {
            driveMotor.setControl(driveController.withVelocity(rpsDriveSetPoint)
                    .withSlot(SwerveConstants.TELEOP_SLOT_CONFIG).withEnableFOC(true));
        }
    ...
    public void logData(SwerveModuleData swerveModuleData) {
        ...
        stallCurrent.update(isStall());
    }

    public boolean isStall() {
        return Math.abs(getDriveVelocity()) < 0.1 && Math.abs(getDriveVolts()) > 0.2;
    }
