...
public class SwerveConstants {
        ...
        // swerve constants
        public final static double WIDTH = 0.566;
        public final static double LENGTH = 0.566;
        ...
        // MotionMagic PID
        public final static double TURNING_kP = 93;
        ...
        // PID
        public final static double AUTO_DRIVE_kP = 0; 
        public final static double AUTO_DRIVE_kI = 0;
        public final static double AUTO_DRIVE_kD = 0;
        public final static double AUTO_DRIVE_kS = 0;
        public final static double AUTO_DRIVE_kV = 0.857;// 857
        public final static double AUTO_DRIVE_kA = 0;

        public final static double TELEOP_DRIVE_kP = 0; //0.1
        public final static double TELEOP_DRIVE_kI = 0;
        public final static double TELEOP_DRIVE_kD = 0;
        public final static double TELEOP_DRIVE_kS = 0;
        public final static double TELEOP_DRIVE_kV = 0.857;// 857
        public final static double TELEOP_DRIVE_kA = 0;

        // Current Limit
        public final static int DRIVE_CURRENT_LIMIT = 80;
        public final static int DRIVE_CONTINUOS_LOWER__LIMIT = 45;
        public final static double DRIVE_CONTINUOUS_CURRENT_DURATION = 0.15;
        public final static boolean DRIVE_ENBLE_CURRENT_LIMIT = true;//true
        ...
        // Module Limits
        public final static ModuleLimits DEFUALT = new ModuleLimits(MAX_VELOCITY, Units.feetToMeters(75 * 1.15),
                        Units.degreesToRadians(700));

        public final static ModuleLimits OPEN_ELEVATOR = new ModuleLimits(3, Units.feetToMeters(17), 
        Units.degreesToRadians(700));
        ...
        public final static double ANGLE_PID_TOLORANCE = 3.5;
        public final static double ANGLE_RANGE = 180;

        // Swerve AutoAdjustXY
        public final static double ABS_X_KP = 1.7;
        public final static double ABS_X_KI = 0;
        public final static double ABS_X_KD = 0;
        
        public final static double ABS_Y_KP = 1.7;//2.3
