...
import frc.robot.Subsystem.Swerve.Util.AutoSwerve;
...
public class SwerveAutoFollower {
    ...
    private static PoseEstimator poseEstimate = PoseEstimator.getInstance();
    private static LoggedPose2d targetPoseLog;
    private static LoggedPose2d currentPoseLog;
